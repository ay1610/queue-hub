import type { TMDBMovie, TMDBTVShow } from "./media";
...
/**
 * Enriched TV show data with IMDB runtime and ratings information
 * Used for server-side data fetching where additional data is pre-loaded
 */
export interface EnrichedTVShowData extends TMDBTVShow {
  // IMDB runtime data
  imdbRuntime?: {
    tconst: string;
    title_type: string | null;
